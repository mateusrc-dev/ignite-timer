...
declare module 'styled-components' { //criando uma tipagem para o módulo styled-components do npm - isso vai fazer com que toda vez que o styled-component seja importado em um arquivo ele vai puxar essa tipagem
