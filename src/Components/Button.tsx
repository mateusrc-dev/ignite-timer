...
interface ButtonProps {
  // vamos criar uma interface para dizer o que o button vai receber e o tipo desses dados
...
export function Button({ variant = 'primary' }: ButtonProps) {
  // poderiamos passar uma className para o ButtonContainer - vamos passar uma propriedade para o componente de estilização - como variant não existe como propriedade, temos que criar uma interface para definir ela em ButtonContainer
